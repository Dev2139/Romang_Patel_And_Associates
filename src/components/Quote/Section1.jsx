...
const About = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url(https://res.cloudinary.com/dsddldquo/image/upload/v1752659117/sqg03hzcspjiydwd68px.jpg)"
      }}
    >
      <div className="container mx-auto py-12 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 animate-slide-in-down">Get A Quote</h1>
