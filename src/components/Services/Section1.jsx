...
const About = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url(https://res.cloudinary.com/dsddldquo/image/upload/v1752657304/r6l5zjvbgfasjdqy0dvh.png)"
      }}
    >
      <div className="container mx-auto py-12 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 animate-slide-in-down">Our Services</h1>
